...
Project.prototype.loadDetails = function (done) {
  ...
  this.__dataSource(function (err, projectData) {
    if (err) {
      return done(err)
    }
...
Project.prototype.loadDataSource = function (dataSource) {
  Object.defineProperty(this, '__dataSource', {
    value: dataSource
  })
}

Project.prototype.loadWhiteListOfLicenses = function (licensesWhiteList) {
